...
// <LSUGRADES> Setup the initialbar.
...
// <LSUGRADES> Add the initialbar tracking object.
...
// <LSUGRADES> Load the initialblar onto the page.
...
if ($USER->gradeediting[$course->id] && ($report->get_pref('showquickfeedback') || $report->get_pref('quickgrading'))) {
    ...
    // <LSUGRADES> Add a submit button to the top of the form for the sake of usability.
    ...
    // <LSUGRADES> Sets the values for intialbar.
